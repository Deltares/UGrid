...
namespace ugridapi
{
    ...
    extern "C"
    {
        ...
        /// @param topology_id 
        /// @return 
        UGRID_API int ug_mesh2d_def(int file_id, Mesh2D const& mesh2d, Mesh2DOptions const& mesh2d_options, int& topology_id);
        ...
        //// @return Error code
        UGRID_API int ug_topology_get_attributes_num(int file_id, int topology_type, int topology_id, int& attributes_num);
